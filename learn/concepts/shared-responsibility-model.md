...
- [**AWS**](../glossary.md#term-aws): [shared responsibility model](https://aws.amazon.com/compliance/shared-responsibility-model/)
- [**Azure**](../glossary.md#term-azure): [shared responsibility in the cloud](https://learn.microsoft.com/en-us/azure/security/fundamentals/shared-responsibility)
- [**GCP**](../glossary.md#term-gcp): [shared responsibilities](https://cloud.google.com/architecture/framework/security/shared-responsibility-shared-fate)
