...
- **Authentication (authn)**: prove you are who you say you are. Username/password, MFA, OAuth, certificates, IAM roles. Result: a verified identity.
- **Authorization (authz)**: given a verified identity, decide what it's allowed to do. Result: yes / no for a specific action on a specific resource.
