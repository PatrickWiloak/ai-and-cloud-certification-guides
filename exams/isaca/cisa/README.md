...
- **Question Types:** Multiple choice (4 options, single best answer)
...
- **Delivery:** PSI test centers worldwide OR online-proctored (remote, with strict environment requirements)
- **Validity:** 3-year CPE cycle (120 CPEs, 20 min/year)
- **Prerequisites:** 5 years of professional IS audit, control, or security work experience. Substitutions available (see Eligibility section).
...
- [Practice Plan](practice-plan.md) - 14-week study schedule
- [Scenarios](scenarios.md) - Realistic CISA-style audit scenarios and finding-writing
- [Strategy](strategy.md) - "BEST answer wins" tactics for ISACA-style questions
...
## Companion and Related Certifications
